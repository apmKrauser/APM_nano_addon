...
// Modified for alpha reduced avg  -2 lowest -2 highest
// STATUS getRedAverage(uint8_t nMedians, float &value)   nMedians: Nr of values around middle to average
...
public:
    ...
    STATUS getRedAverage(uint8_t nMedians, float &value) {
